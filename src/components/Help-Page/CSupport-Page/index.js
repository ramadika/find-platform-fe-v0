...
import { AiFillInstagram, AiOutlineGlobal, AiFillFacebook } from 'react-icons/ai'
// Internals
                        ...
                        <div className="col d-flex align-items-end section1-csupport">
                            <div className="row">
                                <div className="col">
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/" className="ml-5"><AiOutlineGlobal size={25}/></a>
                                    <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/" className="ml-4"><AiFillInstagram size={25}/></a>
                                    <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/" className="ml-4"><AiFillFacebook size={25}/></a>
                                </div>
                                {/* <div className="col">
                                    <h4>
                            ...
                            <form onSubmit={this.postData}>
                                <div className="row justify-content-center mt-3">
                                    <div className="col">
                                        ...
                                        <input type="text" name="firstName" ref={(val) => this.firstName = val} className="form-control" placeholder="First Name" required></input>
                                    </div>
                                    <div className="col">
                                        <h3><b>Last Name <span style={{color:'red'}}>*</span></b></h3>
                                        <input type="text" name="lastName" ref={(val) => this.lastName = val} className="form-control" placeholder="Last Name" required></input>
                                    </div>
                                </div>
                                <h3><b>Email Address <span style={{color:'red'}}>*</span></b></h3>
                                <input type="email" name="email" ref={(val) => this.email = val} className="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email Address" required></input>
                                <h3><b>Message <span style={{color:'red'}}>*</span></b></h3>
                                <textarea name="message" ref={(val) => this.message = val} className="form-control" rows="4" cols="50" placeholder="Message" required></textarea>
