...
export default class index extends Component {
    ...
    // https://103.135.5.242/receiveESP/get.php

    getData = (event) => {
        event.preventDefault();
        event.persist();
        Axios.post("http://192.168.2.8:8080/User-Server/get.php", {
            counter: 1,
        })
        .then(function({data}) {
            if(data.success === 1){
                ...
                <form onSubmit={this.postData}>
                    ...
                    <div className="row justify-content-center mt-3">
                        <div className="col">
                            ...
                            <input type="text" name="nickName" ref={(val) => this.nickName = val} className="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"></input>
                        </div>
                        <div className="col">
